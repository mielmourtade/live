import feedparser, yaml, re, hashlib, html
...
continue
if any(k.lower() in (title+summary).lower() for k in cfg.get('block_keywords', [])):
continue
items.append({
'title': title,
'link': link,
...
# dédup par titre approximatif (clé hash simple)
uniq = {}
for it in items:
